...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label = QtWidgets.QLabel(self.cameraFeedBox)
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.verticalLayout_3.addWidget(self.label)
        self.pushButton_4 = QtWidgets.QPushButton(self.cameraFeedBox)
        ...
        self.label_2 = QtWidgets.QLabel(self.teamLogoBox)
        ...
        self.label_3 = QtWidgets.QLabel(self.motionControlBox)
        ...
        self.spinBox = QtWidgets.QSpinBox(self.speedControlBox)
        self.spinBox.setObjectName("spinBox")
        self.gridLayout_3.addWidget(self.spinBox, 0, 0, 1, 1)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.radioButton_2 = QtWidgets.QRadioButton(self.speedControlBox)
        self.radioButton_2.setCheckable(False)
        self.radioButton_2.setAutoExclusive(True)
        self.radioButton_2.setObjectName("radioButton_2")
        self.horizontalLayout_2.addWidget(self.radioButton_2)
        self.radioButton_3 = QtWidgets.QRadioButton(self.speedControlBox)
        self.radioButton_3.setCheckable(False)
        self.radioButton_3.setObjectName("radioButton_3")
        self.horizontalLayout_2.addWidget(self.radioButton_3)
        self.radioButton = QtWidgets.QRadioButton(self.speedControlBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Camera Feed will be placed here"))
        self.pushButton_4.setText(_translate("MainWindow", "Screen Shot"))
        self.label_2.setText(_translate("MainWindow", "Team Logo will be placed here"))
        self.motionControlBox.setTitle(_translate("MainWindow", "Motion Control"))
        self.label_3.setText(_translate("MainWindow", "motion control arrows will be places here"))
        self.speedControlBox.setTitle(_translate("MainWindow", "Speed Control"))
        self.radioButton_2.setText(_translate("MainWindow", "Low"))
        self.radioButton_3.setText(_translate("MainWindow", "Mid"))
        self.radioButton.setText(_translate("MainWindow", "High"))
