...
cam1 = cv2.VideoCapture("images\\input1.mp4")
cam2 = cv2.VideoCapture("images\\input2.mp4")
out = cv2.VideoWriter('images\\output_video.avi',cv2.VideoWriter_fourcc(*'XVID'),24,(800,650))
while True:
